...
with open(r'TAL-SAQ6K-EN-difficult-vote.json', 'r', encoding='utf-8') as json_file:
    data = json.load(json_file)

begin = max(0,20 * num)

end = min(20 * (num + 1),len(data))
data = data[begin:end]

output_file = rf'output-en-vote\gpt4-answer-EN-{num}.json'
