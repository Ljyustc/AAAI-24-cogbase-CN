...
parser.add_argument('--EN_or_CN', type=str, default="CN", help='Select the script path.')
...
# 脚本路径
if args.EN_or_CN == "EN":
    inner_script_path = script_directory + r"\gpt4_scraper_EN.py"
else:
    inner_script_path = script_directory + r"\gpt4_scraper_CN.py"
