...
with open(script_directory + r"\data\file_to_be_submitted\GPT4_CN_vote_all.json", 'r', encoding='utf-8') as f:
...
write_jsonl(processed_data, script_directory + r"\data\input\GPT4_CN_Verify.json")
